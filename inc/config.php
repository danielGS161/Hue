 ...
 */
	...
	$config['embedding'] = array(
		...
		array(
			...
			'<iframe style="float: left; margin: 10px 20px;" width="%%tb_width%%" height="%%tb_height%%" frameborder="0"  src="https://www.metacafe.com/embed/$2/$3/" autoplay="0" allowfullscreen></iframe>'
		),
		array(
